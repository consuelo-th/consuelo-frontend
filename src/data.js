...
export let blogs = [
    {
      ...
      content: "Meditation has been proven to reduce stress, improve focus, and increase overall well-being. By taking just a few minutes each day to meditate, you can reap these benefits and more.",
      image: "https://example.com/meditation.jpg"
    },
    {
      id: 2,
      title: "5 Tips for Eating Healthier on a Budget",
      content: "Eating healthy doesn't have to be expensive. With a few smart shopping strategies and meal planning, you can enjoy nutritious meals without breaking the bank.",
      image: "https://example.com/healthy-eating.jpg"
    },
    {
      id: 3,
      title: "The Importance of Regular Exercise",
      content: "Regular exercise is essential for maintaining good health and reducing the risk of chronic diseases. Whether it's through running, cycling, or yoga, find an activity that you enjoy and make it a part of your routine.",
      image: "https://example.com/exercise.jpg"
    },
    {
      id: 4,
      title: "How to Start a Successful Online Business",
      content: "Starting an online business can be challenging, but with the right strategies and tools, it's possible to create a profitable and sustainable business. From identifying your niche to building your website, this guide will walk you through the steps to success.",
      image: "https://example.com/online-business.jpg"
    },
    {
      id: 5,
      title: "The Benefits of Learning a New Language",
      content: "Learning a new language can open up a world of opportunities, from travel to career advancement. It can also improve cognitive function and overall brain health. Find a language that interests you and start learning today!",
