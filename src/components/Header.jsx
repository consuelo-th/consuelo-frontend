...
export default () => {
    ...
    useEffect(() => {
        function handleCLickOutside(event) {
            if(showNotification && !(event.target.closest('.noti'))){
    ...
    if (user.isAdmin) {
        return (
            <div className="py-4 px-6 bg-primary-60 text-white flex justify-end items-center relative">
    ...
    return (
        <div className="py-4 px-6 bg-white flex justify-end items-center relative">
            ...
            <div className="flex justify-between items-center gap-2">
                <div className="noti" onClick={() => toggleNotification()}>
                    ...
                    <div className="notification-card__parent">
                        { showNotification && <Notification /> }
                    </div>
                </div>
