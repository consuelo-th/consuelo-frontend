    ...
    return ( 
        <div className="border bg-white shadow-sm rounded-lg p-4 mb-4">
            <div className="flex space-x-4">
                ...
                <p className="text-gray-500"><p className="text-gray-500">Posted on Sep, 22, 2024</p></p>
                </div>
                <button>...</button>
            </div>
            <p class="my-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla at lectus eu mi ultrices vulputate. Fusce semper arcu et sapien semper blandit.</p>
            <div className="flex justify-start gap-4">
                <div className="text-gray-500 flex gap-2 cursor-pointer">
                    <div>
                        <svg className='cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
